...
import { contactInfo, sectionTitles } from "@/src/data/nat";
      ...
      <Container>
        <AnimatedSection>
          <SectionTitle
            ...
            subtitle="Estamos listos para ayudarte con tu próximo proyecto"
          />
        </AnimatedSection>
          ...
          <AnimatedSection direction="left">
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="mb-3 text-sm font-bold tracking-wide text-carbon uppercase">
                    Redes Sociales
                  </h4>
